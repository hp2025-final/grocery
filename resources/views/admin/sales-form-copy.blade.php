...
<div class="flex flex-col max-w-7xl mx-auto">
    ...
    <div class="sales-form bg-white rounded-xl shadow p-2 md:p-4 w-full overflow-hidden">
        <h1 class="text-lg font-bold mb-3 text-gray-800">Admin Sales Form Copy</h1>
        @if(session('success'))
            ...
            <div class="space-y-2">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div>
                        ...
                        <input type="date" name="sale_date" x-model="saleDate" class="block w-full rounded border border-gray-300 px-2 text-xs focus:outline-none focus:ring-1 focus:ring-blue-400" required>
                    </div>
                    <div>
