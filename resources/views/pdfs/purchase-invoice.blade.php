    ...
    <div class="container">
        ...
        <div class="info-grid">
            <div class="col">
                ...
                <div class="value">{{ $purchase->vendor->phone }}</div>
                @endif
            </div>
            <div class="col">
                <div class="label">Invoice Date:</div>
                <div class="value">{{ date('d M Y', strtotime($purchase->purchase_date)) }}</div>
                @if($purchase->notes)
        ...
        <div class="totals">
            <table>
                ...
                <tr class="grand-total">
                    ...
                    <td class="value">{{ number_format($purchase->net_amount, 2) }}</td>
                </tr>
            </table>
        </div>
    </div>
