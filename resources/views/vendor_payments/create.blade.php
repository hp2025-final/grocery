...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 space-y-6">
    ...
    <div class="payment-form bg-white rounded-xl shadow p-4 md:p-6 w-full overflow-hidden">
        <h1 class="text-lg font-bold mb-3 text-gray-800">New Vendor Payments</h1>
        @if(session('success'))
        ...
        <form id="vendor-payment-form" method="POST" action="{{ route('vendor-payments.store') }}" class="max-w-7xl mx-auto" x-data="paymentForm()">
            @csrf
            <div class="space-y-4">
                    ...
                    <div class="entry-card">
                        ...
                        <div class="grid grid-cols-12 gap-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="date" :name="'entries['+index+'][payment_date]'" class="block w-full rounded border border-gray-300 px-2 text-xs focus:outline-none focus:ring-1 focus:ring-blue-400" x-model="entry.payment_date" required>
                            </div>

                            <!-- Vendor (30%) -->
                            <div class="col-span-4">
                                <label class="block text-xs font-medium mb-0.5">Vendor <span class="text-red-500">*</span></label>
                                <select :name="'entries['+index+'][vendor_id]'" class="block w-full rounded border border-gray-300 px-2 text-xs focus:outline-none focus:ring-1 focus:ring-blue-400" x-model="entry.vendor_id" required>
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="number" :name="'entries['+index+'][amount_paid]'" min="0.01" step="0.01" class="block w-full rounded border border-gray-300 px-2 text-xs focus:outline-none focus:ring-1 focus:ring-blue-400" x-model="entry.amount_paid" required>
                            </div>
                            ...
                            <!-- Reference & Notes (20%) -->
                            <div class="col-span-2">
                                <label class="block text-xs font-medium mb-0.5">Reference/Notes</label>
                                <input type="text" :name="'entries['+index+'][notes]'" maxlength="1000" class="block w-full rounded border border-gray-300 px-2 text-xs focus:outline-none focus:ring-1 focus:ring-blue-400" x-model="entry.notes">
                            </div>
    ...
    <div class="bg-white rounded-xl shadow p-4 md:p-6 w-full">
        <div class="max-w-7xl mx-auto">
            <h2 class="text-lg font-bold mb-4">All Vendor Payments</h2>
            <div x-data="vendorPaymentsTable()" x-init="init()" class="min-w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-3 gap-2">
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ route('vendor-payments.export-table') }}" 
