...
<head>
    <meta charset="utf-8">
    <title>Vendor Payments List</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <div style="float: right; margin-top: 10px;">
            <div class="invoice-title">VENDOR PAYMENTS LIST</div>
        </div>
        ...
        <table width="100%">
            <tr>
                <td width="60%">
                    ...
                    <strong>Total Amount:</strong> Rs. {{ number_format($payments->sum('amount_paid'), 2) }}
                </td>
