                    ...
                    @forelse ($allVendors as $i => $vendor)
                        <tr class="hover:bg-blue-50 transition">
                            ...
                            <td class="px-3 py-2 text-center flex gap-2 justify-center">
                                <a href="{{ route('vendors.ledger', $vendor->id) }}" class="inline-block px-2 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-full text-xs font-semibold transition" title="Ledger">
