                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-3 py-2 whitespace-nowrap text-center text-sm space-x-1">
                                ...
                                <a href="{{ route('purchases.edit', $purchase->id) }}" 
                                   class="inline-flex items-center bg-yellow-600 hover:bg-yellow-700 text-white w-6 h-6 justify-center rounded transition-colors duration-200"
                                   title="Edit">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @if($purchase->payment_status === 'Unpaid')
                                    <a href="{{ route('vendor-payments.create-from-purchase', $purchase->id) }}" 
                                       class="inline-flex items-center bg-green-600 hover:bg-green-700 text-white w-6 h-6 justify-center rounded transition-colors duration-200"
