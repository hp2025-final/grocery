...
<div class="max-w-7xl mx-auto">
    <div class="purchase-form bg-white rounded-xl shadow p-2 md:p-4 w-full overflow-hidden">
        <h1 class="text-lg font-bold mb-3 text-gray-800">Edit Purchase</h1>
        ...
        <form method="POST" action="{{ route('purchases.update', $purchase->id) }}" x-data="purchaseForm()" @submit="submitForm">
            @csrf
            @method('PUT')
            <div class="space-y-2">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div>
                        ...
                        <input type="date" name="purchase_date" x-model="purchaseDate" 
                ...
                <div class="flex justify-end space-x-2 pt-4">
                    <a href="{{ route('purchases.create') }}" class="px-3 py-1.5 border border-gray-300 rounded text-gray-600 text-sm hover:bg-gray-50 transition-colors">
                        Cancel
                    </a>
...
function purchaseForm() {
    return {
        ...
        filteredProducts(idx) {
            ...
            // This ensures that existing purchase items show their selected products during edit
