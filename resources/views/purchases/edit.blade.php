...
<div class="max-w-4xl mx-auto">
    <div class="purchase-form bg-white rounded-xl shadow p-4 md:p-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Purchase</h1>
            <a href="{{ route('purchases.create') }}" class="inline-block px-4 py-2 border border-gray-300 text-gray-700 rounded hover:bg-gray-50 transition">Back to Purchases</a>
        </div>
        ...
        <form method="POST" action="{{ route('purchases.update', $purchase->id) }}" x-data="purchaseForm()" @submit.prevent="submitForm">
        @csrf
        @method('PUT')
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="purchase_date" x-model="purchaseDate" value="{{ $purchase->purchase_date }}" class="block w-full rounded border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" min="0" step="0.01" name="discount" x-model.number="discount" value="{{ $purchase->discount_amount }}"
                            class="block w-full rounded border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" />
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" rows="2" x-model="notes"
                            class="block w-full rounded border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>{{ $purchase->notes }}</textarea>
            </div>
        </div>
                ...
                <div class="flex justify-end pt-4">
                    <div class="space-x-2">
                        <a href="{{ route('purchases.create') }}" class="inline-block px-4 py-2 border border-gray-300 text-gray-700 rounded hover:bg-gray-50 transition">Cancel</a>
